...
const Waves = ({
                   lineColor = '#a22c29', // Defaulting to your red accent color
    ...
    useEffect(() => {
        ...
        // We attach mousemove to the container or window depending on preference
        // Here using window to catch fast movements better
